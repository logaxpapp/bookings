...
const Subscriptions = () => {
  ...
  return (
    <section className="flex flex-col gap-6 h-full overflow-auto">
      <header className="flex flex-col items-center gap-2">
        <Heading>Your Subscriptions</Heading>
        <h2 className="m-0 font-medium text-sm text-[#5c5c5c] text-center">
          {subscription ? (
            <>
              <span>You are currently subscribed to the&nbsp;</span>
              <span>{subscription?.name}</span>
              <span>&nbsp;plan.&nbsp;</span>
            </>
          ) : null}
          <span>Please choose a subscription plan below to proceed</span>
        </h2>
      </header>
