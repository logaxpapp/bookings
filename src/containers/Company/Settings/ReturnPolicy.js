...
export const ReturnPolicyComponent = ({
  ...
  <section style={styles.container}>
    ...
    <p className="pt-4"><strong>1. Introduction</strong></p>
    <p>
    ...
    <p className="pt-4"><strong>2. Cancellation Policy</strong></p>
    <p>
      Customers who wish to cancel their appointments must adhere to the following guidelines:
    </p>
    <p className="pt-4"><strong>2.1. Timeframe for Cancellation</strong></p>
    <ul className="m-0 p-0">
      <li>
        {`Appointments must be canceled at least ${minNoticeTime} before the scheduled appointment time to qualify for a refund of the deposit.`}
      </li>
    </ul>
    <p className="pt-4"><strong>2.2. Deposit Forfeiture</strong></p>
    <ul>
      <li>
        {`If a customer fails to cancel their appointment within the specified
        ${minNoticeTime} timeframe, the deposit paid for the appointment will be forfeited.`}
      </li>
    </ul>
    <p className="pt-4"><strong>3. Refund Process</strong></p>
    <p className="pt-1"><strong>3.1. Eligibility for Refund</strong></p>
    <ul>
      <li>
    ...
    <p className="pt-4"><strong>3.2. Refund Amount</strong></p>
    <ul>
      <li>
        {`Refunds will be processed for ${refundPercent} percent of the deposit amount paid for the appointment.`}
      </li>
    </ul>
    <p className="pt-4"><strong>3.3. Refund Timeline</strong></p>
    <ul>
      <li>
        {`Refunds will be processed within ${refundDelay} (business days) from the date of the cancellation.`}
      </li>
    </ul>
    <p className="pt-4"><strong>3.4. Refund Method</strong></p>
    <ul>
      <li>
    ...
    <p className="pt-4"><strong>4. Contact Information</strong></p>
    <p>
    ...
    <p className="pt-4"><strong>5. Amendments to the Return Policy</strong></p>
    <p>
...
ReturnPolicyComponent.propTypes = {
  ...
  minNoticeTime: PropTypes.string,
  refundPercent: PropTypes.number,
  refundDelay: PropTypes.string,
