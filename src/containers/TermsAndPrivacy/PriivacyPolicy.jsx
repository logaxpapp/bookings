...
const PrivacyPolicyComponent = () => (
  <section className={css.container}>
    ...
    <p><b>SERVICE / COMPANY</b> (referred to as either &quot;the Service&quot;, &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to LogaXP and all the websites operated by LogaXP.</p>
    ...
    <p><b>YOU / USER</b> is the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable. The User corresponds to the Data Subject, who is the subject of Personal Data.</p>
    ...
    <p><b>Other Data</b></p>
    <p>While using our Service, we may also collect the following information: sex, age, date of birth, place of birth, passport details, citizenship, registration at place of residence and actual address, telephone number (work, mobile), details of documents on education, qualification, professional training, employment agreements, <span title="Non Disclosure Agreements" className="link">NDA agreements</span>, information on bonuses and compensation, information on marital status, family members, social security (or other taxpayer identification) number, office location and other data.</p>
    <p>5. <b>Use of Data</b></p>
    <p>LogaXP uses the collected data for various purposes:</p>
    ...
    <p>LogaXP will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
    ...
    <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>enquiries@logaxp.com</b>.</p>
    ...
    <p>0.4. users are able to change their personal information by emailing us at <b>enquiries@logaxp.com</b>.</p>
    ...
    <p>
      <b>
        ...
        rent your personal information to any third parties for any purpose. We
