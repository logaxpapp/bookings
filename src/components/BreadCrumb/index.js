...
const BreadCrumb = ({ name, handleInputChange }) => {
  ...
  return (
    <section className="w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-row items-center px-4 py-4 shadow-2 md:px-6 2xl:px-11">
          ...
          >
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-transparent pl-9 pr-4 text-black focus:outline-none border border-black dark:text-white xl:w-125"
              />
            </div>
            <div className="relative">
              <button
              ...
              <div
                ...
                className={`absolute mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark text-black dark:text-white dark:bg-boxdark ${
                  filterOpen === true ? 'block' : 'hidden'
                }`}
              >
                <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                  <li>Use my device location</li>
                  <li>Use my home location</li>
                  <li>
                    Use my service provider location
                  </li>
                  <li>
        ...
        <div className="w-2/12">
          <div className="relative">
            <button
              ...
              className="bg-[#011C39] py-4 rounded-xl px-2 text-white dark:bg-white dark:text-black flex items-center gap-4"
            >
              Book Appointment
            </button>
